...
export interface IUserLoginRespArgs {
    userId: number | string | thrift.Int64;
    token: string;
    message: string;
}
export const UserLoginRespCodec: thrift.IStructCodec<IUserLoginRespArgs, IUserLoginResp> = {
    encode(args: IUserLoginRespArgs, output: thrift.TProtocol): void {
        const obj: any = {
        ...
        output.writeStructBegin("UserLoginResp");
        if (obj.userId != null) {
    ...
    decode(input: thrift.TProtocol): IUserLoginResp {
        let _args: any = {};
        ...
        if (_args.userId !== undefined && _args.token !== undefined && _args.message !== undefined) {
            ...
            throw new thrift.TProtocolException(thrift.TProtocolExceptionType.UNKNOWN, "Unable to read UserLoginResp from input");
        }
    }
};
export class UserLoginResp extends thrift.StructLike implements IUserLoginResp {
    public userId: thrift.Int64;
    public token: string;
    public message: string;
    public readonly _annotations: thrift.IThriftAnnotations = {};
    public readonly _fieldAnnotations: thrift.IFieldAnnotations = {};
    constructor(args: IUserLoginRespArgs) {
        super();
        if (args.userId != null) {
    ...
    public static read(input: thrift.TProtocol): UserLoginResp {
        return new UserLoginResp(UserLoginRespCodec.decode(input));
    }
    public static write(args: IUserLoginRespArgs, output: thrift.TProtocol): void {
        return UserLoginRespCodec.encode(args, output);
    }
    public write(output: thrift.TProtocol): void {
        return UserLoginRespCodec.encode(this, output);
    }
}
